...
template<typename PixelType>
static void sorting(Image<PixelType> &I1, Image<PixelType> &I2, Image<PixelType> &I3, Image<PixelType> &I4, Image<PixelType> &I5, Image<PixelType> &I6, Image<PixelType> &I7, int N)
{
    PixelType* d[7];
    d[0] = I1.GetPointer();
    d[1] = I2.GetPointer();
...
std::vector<IndexType> sort_image_value(PixelType *I, int size)
